...
import static com.technokratos.kirillakhmetov.util.db.SqlQuery.Finance.SQL_PROFIT_ANALYSIS_BY_OWNER_ID;
...
public class FinanceRepository {
    ...
    public void deleteAll() {
        jdbcTemplate.update(SqlQuery.SQL_DELETE, new MapSqlParameterSource());
    }
